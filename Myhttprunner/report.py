...
from Myhttprunner import loader, logger
from Myhttprunner.__about__ import __version__
from Myhttprunner.compat import basestring, bytes, json, numeric_types
